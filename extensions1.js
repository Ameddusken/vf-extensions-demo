...
export const MapExtension = {
  ...
  render: ({ trace, element }) => {
    ...
    inner.setAttribute('data-onvisible-trigger', '1');
    inner.style.paddingLeft = '2rem';
    inner.style.paddingRight = '2rem';
    ...
    form.action = 'https://bujeconsulting.dk/post/contact';
    form.id = 'form02';
    form.method = 'post';
    form.className = 'style2';

    // Create the inner form div
    const formInner = document.createElement('div');
    formInner.className = 'inner';

    // Function to create form fields
    const createField = (labelText, inputType, inputName, inputId, inputMaxLength) => {
      const fieldDiv = document.createElement('div');
      fieldDiv.className = 'field';

      const label = document.createElement('label');
      label.style.color = '#0D0C0C';
    ...
    formInner.appendChild(createField('Navn', 'text', 'name', 'form02-name', 128));
    formInner.appendChild(createField('Email', 'email', 'email', 'form02-email', 128));
    formInner.appendChild(createField('Telefonnummer', 'text', 'phone', 'form02-phone', 64));
    formInner.appendChild(createField('Besked', 'textarea', 'message', 'form02-message', 16384));
    ...
    use.setAttribute('xlink:href', '#icon-67ad41ecc66a1b1cd00d0d3b20c00017');
    svg.appendChild(use);
    ...
    formInner.appendChild(actionsDiv);

    // Append inner div to form
    ...
    hiddenInput.name = 'id';
    hiddenInput.value = 'form02';
    form.appendChild(hiddenInput);

    // Append h1 and form to inner div
    inner.appendChild(h1);
    inner.appendChild(form);

    // Append inner div to wrapper
    wrapper.appendChild(inner);

    // Append wrapper to the provided element
